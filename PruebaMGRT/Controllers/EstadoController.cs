...
namespace PruebaMGRT.Controllers
{
    public class EstadoController : Controller
    {
        ...
        public EstadoController(PrubTecnicaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreEstado,FechaCreacion")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,NombreEstado,FechaCreacion")] Estado estado)
        {
            if (id != estado.Id)
            {
                return NotFound();
